...
const Hero = () => {
  return (
    // Adicionei overflow-hidden para garantir que nada vase
    <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-background to-muted/30 overflow-x-hidden">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          {/* AQUI ESTÁ O SEGREDO: flex-col e items-center para celular, items-start para PC */}
          <div className="space-y-8 flex flex-col items-center text-center md:items-start md:text-left">
            ...
            {/* Prova Social */}
            {/* No celular, mx-auto centraliza a caixa se ela tiver largura fixa */}
            <div className="flex items-start gap-3 p-4 bg-white rounded-xl shadow-md w-full max-w-md md:max-w-none">
            ...
            <div className="space-y-4 w-full flex flex-col items-center md:items-start">
              ...
              {/* Ícones de check - Centralizados no mobile */}
